...
from students_folder.savandr.lab_2.lab_2 import UserSpec

@pytest.mark.sae_lab3
def test_class_user_spec(yaml_test_data):
    test_cases = yaml_test_data("Savvateev/lab_3/UserSpec.yaml")
    for test_desc, value, answer in test_cases:
        logger = logging.getLogger("test_user_spec")
