...
from students_folder.savandr.lab_2.lab_2 import OrderLineSpec

@pytest.mark.sae_lab3
def test_class_order_line_spec(yaml_test_data):
    test_cases = yaml_test_data("Savvateev/lab_3/OrderLineSpec.yaml")
