...
from students_folder.savandr.lab_2.lab_2 import ServiceSpec

@pytest.mark.sae_lab3
def test_class_service_spec(yaml_test_data):
    test_cases = yaml_test_data("Savvateev/lab_3/ServiceSpec.yaml")
    for test_desc, value, answer in test_cases:
        logger = logging.getLogger("test_service_spec")
