...
from students_folder.Zhukova_Mariya.lab2.main import ProfileSpec

logger = logging.getLogger("test_ProfileSpec")


@pytest.mark.zhukova_lab3
def test_class_ProfileSpec(yaml_test_data):
    test_cases = yaml_test_data("Zhukova/lab_3/ProfileSpec.yaml")
