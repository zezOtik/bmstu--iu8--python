...
from students_folder.Zhukova_Mariya.lab2.main import OrdersSpec

logger = logging.getLogger("test_OrdersSpec")


@pytest.mark.zhukova_lab3
def test_class_OrdersSpec(yaml_test_data):
    test_cases = yaml_test_data("Zhukova/lab_3/OrdersSpec.yaml")
