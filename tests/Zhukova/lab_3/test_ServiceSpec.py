...
from students_folder.Zhukova_Mariya.lab2.main import ServiceSpec

logger = logging.getLogger("test_ServiceSpec")


@pytest.mark.zhukova_lab3
def test_class_ServiceSpec(yaml_test_data):
    test_cases = yaml_test_data("Zhukova/lab_3/ServiceSpec.yaml")
