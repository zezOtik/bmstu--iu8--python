...
from students_folder.Zhukova_Mariya.lab2.main import OrderSpec

logger = logging.getLogger("test_OrderSpec")


@pytest.mark.zhukova_lab3
def test_class_OrderSpec(yaml_test_data):
    test_cases = yaml_test_data("Zhukova/lab_3/OrderSpec.yaml")
