...
from students_folder.Zhukova_Mariya.lab2.main import UserSpec

logger = logging.getLogger("test_UserSpec")


@pytest.mark.zhukova_lab3
def test_class_UserSpec(yaml_test_data):
    test_cases = yaml_test_data("Zhukova/lab_3/UserSpec.yaml")
