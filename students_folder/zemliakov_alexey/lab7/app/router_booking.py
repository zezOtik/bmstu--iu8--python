...
from app.models.store_models import BookingReserve, DeleteBookingReserve, UserBookingGet, BookingListGet
...
async def get_rooms(user: UserBookingGet = Depends()) -> List[BookingListGet]:
